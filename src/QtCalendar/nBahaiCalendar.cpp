...
N::BahaiCalendar:: BahaiCalendar    (void)
                 : AbstractCalendar (    )
{
}
...
QString N::BahaiCalendar::toString(QString format)
{
  return "" ;
}

void N::BahaiCalendar::update(void)
{
  Time::update ()                     ;
  locate ()                           ;
...
void N::BahaiCalendar::locate(void)
{
...
int N::BahaiCalendar::year(void)
{
  return wyear ;
}

int N::BahaiCalendar::month(void)
{
  return wmonth ;
}

int N::BahaiCalendar::mday(void)
{
  return wdays  ;
}

int N::BahaiCalendar::weekday(void)
{
  return dweek  ;
}

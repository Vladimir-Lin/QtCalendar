...
N::ArmenianCalendar:: ArmenianCalendar (void)
                    : AbstractCalendar (    )
{
}
...
QString N::ArmenianCalendar::toString(QString format)
{
  return "" ;
}

void N::ArmenianCalendar::update(void)
{
  Time::update ()                     ;
  locate ()                           ;
...
void N::ArmenianCalendar::locate(void)
{
...
int N::ArmenianCalendar::year(void)
{
  return wyear  ;
}

int N::ArmenianCalendar::month(void)
{
  return wmonth ;
}

int N::ArmenianCalendar::mday(void)
{
  return wdays  ;
}

int N::ArmenianCalendar::weekday(void)
{
  return dweek  ;
}
